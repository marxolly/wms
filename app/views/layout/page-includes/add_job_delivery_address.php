...
<div id="address_<?php echo $i;?>" class="p-3 mid-grey mb-3 anaddress">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <input type="text" data-group="attention" class="form-control hasgroup" name="addresses[<?php echo $i;?>][attention]" id="d_<?php echo $i;?>_attention" value="<?php echo $attention;?>" />
        </div>
    </div>
    <div class="form-group row">
        <label class="col-md-4 col-form-label">Delivery Instructions</label>
        <div class="col-md-8">
            <textarea class="form-control hasgroup" data-group="delivery_instructions" name="addresses[<?php echo $i;?>][delivery_instructions]" id="d_<?php echo $i;?>_delivery_instructions" placeholder="Instructions For Driver"><?php echo $delivery_instructions;?></textarea>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <input type="text" data-group="address2" class="form-control hasgroup" name="addresses[<?php echo $i;?>][address2]" id="d_<?php echo $i;?>_address2" value="<?php echo $daddress_2;?>" />
        </div>
    </div>
    <div class="form-group row">
    ...
    <input type="hidden" class="hasgroup" data-group="address_id" name="addresses[<?php echo $i;?>][address_id]" id="d_<?php echo $i;?>_address_id" value="<?php echo $address_id;?>"
