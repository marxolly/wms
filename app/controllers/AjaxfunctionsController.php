...
class ajaxfunctionsController extends Controller
{
    ...
    public function addPOItem()
    {
        ...
        $html = $this->view->render(Config::get('VIEWS_PATH') . 'layout/page-includes/add_poitem.php', [
            'i'     =>  $i
        ]);
        $data['html'] = $html;
        $this->view->renderJson($data);
    ...
    public function makePOFinisherContactSelect()
    {
        $finisher_id = $this->request->data['finisher_id'];
        $data = array(
            'error'     =>  false,
        ...
        $html = $this->view->render(Config::get('VIEWS_PATH') . 'layout/page-includes/po_finisher_contact_selector.php', [
            'finisher_id'     =>  $finisher_id
        ]);
        $data['html'] = $html;
        $this->view->renderJson($data);
    ...
    {
        //echo "<pre>",print_r($this->request),"</pre>";die();
        $data = $this->productionjob->getAutocompleteJobs($this->request->query['term']);
        //echo "<pre>",print_r($data),"</pre>";//die();
        $this->view->renderJson($data);
    }
