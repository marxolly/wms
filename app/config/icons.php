...
$fontastic_icons = array(
    ...
    'display-settings'  => array(
        'upload-images' => '<div class="fa-2x"><span class="fa-layers fa-fw"><i class="fad fa-file-image"></i><i class="fas fa-arrow-up" data-fa-transform="shrink-2 up-2"></i></span></div>'
    ),
    'finishers' => array(
